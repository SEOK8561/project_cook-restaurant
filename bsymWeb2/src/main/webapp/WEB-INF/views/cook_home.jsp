				...
				<div class="cook_board">
					...
					<div class="cook_board_function_box">
						...
						<c:choose>
						    ...
						    <c:otherwise>
						    	<div onclick="likes(true,${item.id})"><i class="material-icons" style="cursor:pointer">favorite_border</i></div>
    ...
    $(document).on('click', '.remove', function () {
      ...
      $( ".carousel" ).on( "click", "a", function() {
		...
		for (var i in re) {
		          ...
		          inbox = inbox + "<div onclick='likes(true,${item.id})'><i class='material-icons' style='cursor:pointer'>favorite_border</i></div>"
    		...
    		if(check){
    			...
    			fetch(url,{
    				...
    				if(result === 'ok'){
    					...
    					like_el.innerHTML = "<div onclick='likes(false,"+id+")'><i class='material-icons' style='cursor:pointer'>favorite</i></div>";
    				}else{
    					alert("로그인을 해주세요.")
    				}
    			}).catch();
    			...
    			fetch(url,{
    				...
    				if(result === 'ok'){
    					let like_el = document.querySelector('#b'+id);
    					like_el.innerHTML = "<div onclick='likes(true,"+id+")'><i class='material-icons' style='cursor:pointer'>favorite_border</i></div>";
    				}else{
    					alert("로그인을 해주세요.")
    				}
    			}).catch();
